...
let AuthService = class AuthService {
    ...
    async register(dto) {
        ...
        try {
            ...
            if (e instanceof client_1.Prisma.PrismaClientKnownRequestError &&
                e.code === 'P2002') {
                throw new common_1.ConflictException('Ten adres email jest już zajęty');
            }
            throw e;
        }
    }
    ...
    async buildAuthResponse(user, remember) {
        ...
        const accessToken = await this.jwt.signAsync({ sub: user.id, email: user.email }, signOptions);
